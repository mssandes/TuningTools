...
tight20160701 = np.array(
  ...
  ,[0.902375,  0.90035135, 0.8235, 0.90092632]]) # Et 50
...
# eta 0          0.8         1.37        1.54
  ...
  ,[ 0.947125, 0.94508108, 0.8595,  0.93848421]]) # Et 50
...
# eta 0          0.8         1.37        1.54
  ...
  ,[ 0.97525, 0.97298649, 0.887,   0.96703158]]) # Et 50

from RingerCore import traverse
pdrefs = medium20160701
pfrefs = np.array( [[0.05]*len(etaBins)]*len(etBins) )

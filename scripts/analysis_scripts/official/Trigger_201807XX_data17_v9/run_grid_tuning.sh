...
runGRIDtuning.py \
 ...
 -d user.jodafons.data17_13TeV.AllPeriods.sgn.probes_EGAM2.bkg.VProbes_EGAM7.Rel21.GRL_v97.npz  \
 ...
 -o user.jodafons.nn.data17_13TeV.AllPeriods.sgn_Jpsi_EGAM2.bkg_EGAM7.Rel21.bestSP.Norm1.v9.t0001 \

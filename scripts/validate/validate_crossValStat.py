...
#stat('sp')
stat.save_network('sp',5,46,75,-0.734000,'network.tight.'+data+'.pic')
stat.save_network('sp',18,15,45,-0.030001,'network.medium.'+data+'.pic')
stat.save_network('sp',7,39,22,0.449999,'network.loose.'+data+'.pic')

...
struct RingerPhysVal_v2 /*: public TObject*/ {
    ...
    uint8_t             el_nsihits         ;
    uint8_t             el_nsideadsensors  ;
    uint8_t             el_npixdeadsensors ;
    uint8_t             el_nsctdeadsensors ;
    uint8_t             el_expectNextToInnerMostLayer;
    uint8_t             el_nNextToInnerMostLayerHits;
    uint8_t             el_nNextToInnerMostLayerOutliers;
    float               el_sigd0;
    float               el_d0;
    float               el_deltaE;
    float               el_e277;
    float               el_eProbabilityHT;
    float               el_transformed_eProbabilityHT;
    float               el_d0significance;
    float               el_deltaPhiRescaled2;
    float               el_deltaEta1;
    float               el_deltaPOverP;
    float               el_qOverP;
    bool                el_loose{};
    bool                el_medium{};
    bool                el_tight{};
    ...
    float               trig_L2_calo_emu_nnOutput{};      
    ...
    std::vector<float>               *trig_EF_el_deta1;
    ...
    std::vector<uint8_t>             *trig_EF_el_nblayerhits;
    std::vector<uint8_t>             *trig_EF_el_nblayerolhits;
    std::vector<uint8_t>             *trig_EF_el_npixhits;
    std::vector<uint8_t>             *trig_EF_el_npixolhits;
    std::vector<uint8_t>             *trig_EF_el_nscthits;
    std::vector<uint8_t>             *trig_EF_el_nsctolhits;
    std::vector<uint8_t>             *trig_EF_el_ntrthightreshits;
    std::vector<uint8_t>             *trig_EF_el_ntrthits;
    std::vector<uint8_t>             *trig_EF_el_ntrthighthresolhits;
    std::vector<uint8_t>             *trig_EF_el_ntrtolhits;
    std::vector<uint8_t>             *trig_EF_el_ntrtxenonhits;
    std::vector<uint8_t>             *trig_EF_el_expectblayerhit;
    std::vector<uint8_t>             *trig_EF_el_transformed_expectblayerhit;
    std::vector<uint8_t>             *trig_EF_el_nsihits         ;
    std::vector<uint8_t>             *trig_EF_el_nsideadsensors  ;
    std::vector<uint8_t>             *trig_EF_el_npixdeadsensors ;
    std::vector<uint8_t>             *trig_EF_el_nsctdeadsensors ;
    std::vector<uint8_t>             *trig_EF_el_expectNextToInnerMostLayer;
    std::vector<uint8_t>             *trig_EF_el_nNextToInnerMostLayerHits;
    std::vector<uint8_t>             *trig_EF_el_nNextToInnerMostLayerOutliers;
    std::vector<float>               *trig_EF_el_sigd0;
    std::vector<float>               *trig_EF_el_d0;
    std::vector<float>               *trig_EF_el_deltaE;
    std::vector<float>               *trig_EF_el_e277;
    std::vector<float>               *trig_EF_el_eProbabilityHT;
    std::vector<float>               *trig_EF_el_transformed_eProbabilityHT;
    std::vector<float>               *trig_EF_el_d0significance;
    std::vector<float>               *trig_EF_el_deltaPhiRescaled2;
    std::vector<float>               *trig_EF_el_deltaEta1;
    std::vector<float>               *trig_EF_el_deltaPOverP;
    std::vector<float>               *trig_EF_el_qOverP;
